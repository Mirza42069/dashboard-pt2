<script lang="ts">
	...
	const formattedLabel = $derived.by(() => {
		...
		// Narrowed explicitly rather than relying on the length check above: this
		// package builds with noUncheckedIndexedAccess, so a destructured element
		// is `T | undefined` no matter what was asserted about the array.
